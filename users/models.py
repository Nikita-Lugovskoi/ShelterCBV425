...
class User(AbstractUser):
    ...
    first_name = models.CharField(max_length=250, verbose_name='Имя', default='Anonymous')
    last_name = models.CharField(max_length=250, verbose_name='Фамилия', default='Anonymous')
