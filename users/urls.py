...
from users.views import UserRegisterView, UserLoginView, UserProfileView, user_logout_view, \
                        UserUpdateView, user_change_password_view, user_generate_new_password_view
